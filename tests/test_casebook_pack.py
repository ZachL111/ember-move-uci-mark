"""Regression checks for the ember-move-uci-mark casebook."""
...
from casebook.harness import assert_expected, ember_move_uci_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_move_uci_mark_summary(), assert_expected())
